...
<head>
    ...
    <link rel="shortcut icon"
          href="<%=path %>/bootstrap/images/wo.jpg">
        ...
        $('#fileTable').bootstrapTable({
            ...
            columns: [
                ...
                {field: 'ftime', title: '上传时间', align: 'center'},
                {
                    ...
                    formatter: function (value, row, index) {
                        return '<a href="#" onclick="preView(\'' + value + '\',\'' + row.ftype + '\',\'' + row.fsuffix + '\')">预览</a>&nbsp;&nbsp;<a href="#" onclick="viewFile(\'' + value + '\')">详情</a>&nbsp;&nbsp;<a href="#" onclick="dislikeFile(\'' + value + '\')">取消收藏</a>&nbsp;&nbsp;<a href="#" onclick="modifyFile(\'' + value + '\')">编辑</a>';
                    }
                }
            ],
